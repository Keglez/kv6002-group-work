        ...
        <footer className="flex flex-col items-center bg-foreground-col text-center text-surface dark:bg-foreground-col dark:text-white">
            ...
            <div className="container pt-6 pb-1">
                ...
                <div className="mb-4 flex justify-center space-x-5">
                    ...
                    {/* Google */}
                    <a href="https://www.google.com/" type="button" className="rounded-full bg-transparent p-2 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-col" data-twe-ripple-init="">
                    ...
                    {/* Github */}
                    <a href="https://github.com/" type="button" className="rounded-full bg-transparent p-2 font-medium uppercase leading-normal text-surface transition duration-150 ease-in-out hover:bg-neutral-100 focus:outline-none focus:ring-0 dark:text-white dark:hover:bg-secondary-col" data-twe-ripple-init="">
                        <span className="mx-auto [&>svg]:h-4 [&>svg]:w-4">
