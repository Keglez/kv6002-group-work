...
return (
  <div className="flex flex-col h-screen min-h-screen justify-between  bg-black text-red-500 p-4">
    ...
    <div className="mt-8">
        ...
        <Section key={index} title={category.title} contents={category.contents} />
        ))}
    </div>
    {/* Display Footer */}
    <Footer />
